...
using LMS.Business.Interface.Mapping;

namespace LMS.Business.Infrastructure.AutoMapper
{
    ...
    public static class MapperProfileHelper
    {
        public static IList<Map> LoadStandardMappings(Assembly rootAssembly)
        {
            ...
            var mapsFrom = (
                ...
                where
                    instance.IsGenericType && instance.GetGenericTypeDefinition() == typeof(Common.Mappings.IMapFrom<>) &&
                    !type.IsAbstract &&
                    !type.IsInterface
                select new Map
                {
